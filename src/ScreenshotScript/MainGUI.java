...
public class MainGUI extends JFrame {
	...
	public MainGUI(Control pControl) {
		...
		Object[][] dataMain = {
				...
				{ tblImageMain[96][0], tblImageMain[96][1], tblImageMain[96][2], tblImageMain[96][3], tblImageMain[96][4], tblImageMain[96][5], tblImageMain[96][6], tblImageMain[96][7] },
				{ tblImageMain[97][0], tblImageMain[97][1], tblImageMain[97][2], tblImageMain[97][3], tblImageMain[97][4], tblImageMain[97][5], tblImageMain[97][6], tblImageMain[97][7] },
				{ tblImageMain[98][0], tblImageMain[98][1], tblImageMain[98][2], tblImageMain[98][3], tblImageMain[98][4], tblImageMain[98][5], tblImageMain[98][6], tblImageMain[98][7] },
				{ tblImageMain[99][0], tblImageMain[99][1], tblImageMain[99][2], tblImageMain[99][3], tblImageMain[99][4], tblImageMain[99][5], tblImageMain[99][6], tblImageMain[99][7] },
				};
