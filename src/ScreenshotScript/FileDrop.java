...
//original class can be downloaded here: http://www.iharder.net/current/java/filedrop/
...
public class FileDrop
{
    ...
    final boolean recursive,
    final Listener listener) {   
    	this( out, c, javax.swing.BorderFactory.createMatteBorder( 2, 2, 2, 2, defaultBorderColor ), listener );
    }
...
//Suppress Warnings to reduce Warnings	
